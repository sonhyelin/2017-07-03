...
<!--                      visual 부분                           -->
           ...
           <main id="main">
            <div id="main-pont">
               <nav id="seach-form">
                  ...
                  <label class="title">탈퇴회원목록</label>
                  <form>
                  <label>검색어</label>
                  <input type="text"/>
                  </form>
                        ...
                        <br/> 
                         <table class="table-garo">
                          <tr>
                            ...
                            <th class="id">아이디</th>
                            <th class="regdate">탈퇴날짜</th>
                           <th class="choice">탈퇴승인여부<input type="checkbox" id="check-all"/></th>
                          </tr>
                           <tr>
                             <td>1</td>
	...
	<!-- aside  부분 -->
				<jsp:include page="../../../views/admin/member-mng/inc/aside-member-mng.jsp"></jsp:include>
